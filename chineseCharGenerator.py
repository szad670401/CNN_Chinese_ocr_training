...
DroidSansFallbackFull = ImageFont.truetype("./font/DroidSansFallbackFull.ttf", 36, 0);
fangzheng_fangsong = ImageFont.truetype("./font/fangzheng_fangsong.ttf", 36, 0);
fangzheng_heiti = ImageFont.truetype("./font/fangzheng_heiti.ttf", 36, 0);
fangzheng_shusong = ImageFont.truetype('./font/fangzheng_shusong.ttf',36,0)
Lantinghei = ImageFont.truetype('./font/Lantinghei.ttc',36,0)
mingliu = ImageFont.truetype('./font/mingliu.ttc',36,0)
NotoSansHans_Black = ImageFont.truetype('./font/NotoSansHans-Black.otf',36,0)
NotoSansHans_Bold = ImageFont.truetype('./font/NotoSansHans-Bold.otf',36,0)
NotoSansHans_DemiLight = ImageFont.truetype('./font/NotoSansHans-DemiLight.otf',36,0)
NotoSansHans_Light = ImageFont.truetype('./font/NotoSansHans-Light.otf',36,0)
NotoSansHans_Medium = ImageFont.truetype('./font/NotoSansHans-Medium.otf',36,0)
NotoSansHans_Regular = ImageFont.truetype('./font/NotoSansHans-Regular.otf',36,0)
NotoSansHans_Thin_Windows = ImageFont.truetype('./font/NotoSansHans-Thin-Windows.otf',36,0)
